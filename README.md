...
- 🖼️ MySql: Relational database management system used for .pdf data storage.
...
- 🗄️ Hibernate: Object-relational mapping (ORM) framework for mapping an object-oriented domain model to a relational
  database.
